...
public class JobMbtiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_job_mbti);                     // xml과 java 소스 연결
        ...
        adapter = new MbtiAdapter(JobMbtiActivity.this, getMbtiList(mbti));    // ListView를 위한 adapter 생성(List는 함수를 통해 생성함)
