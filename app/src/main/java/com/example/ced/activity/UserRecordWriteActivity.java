...
public class UserRecordWriteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_record_write);                // xml, java 연결
        ...
        writeAddButton.setOnClickListener(new View.OnClickListener() {      // 저장 버튼을 누를 때
            ...
            public void onClick(View v) {
                ...
                ((UserRecordListActivity) UserRecordListActivity.context_record).saveRecord(new Record(title, date, content));
